...
- The schema contract family, with what each contract says: [guide chapter 2](guide/2-schema.md#the-graph-describes-itself). Read any of them with `mix bs show cb:b051` (and so on), or walk one with `mix bs tree`.
