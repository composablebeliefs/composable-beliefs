...
- **[Belief knowledge base](docs/kb/README.md)** - one generated markdown page per belief, navigable along deps, reverse deps, and supersession; regenerated by `mix cb.generate.kb` and kept fresh in CI (`cb:b599`).
