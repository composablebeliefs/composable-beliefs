...
- [2026-07-06 - atomization migration (graph decomposed to atoms and swapped, cb:b597, PR #29)](2026-07-06-atomization-migration.md) - hook-rendered, /end run in its own turn; the wholesale atomization migration end to end: assessed the operator's decomposition proposal against the graph (already doctrine per cb:b475/b402/b405, violated in practice - zero aggregations ever), minted the mechanism as cb:b597, built the spec-driven regenerable generator (mix cb.migrate.atomize, plans/atomize/), decomposed the full descriptive lane (31 aggregations over 115 atoms) and three prescriptive tranches (24 restates), swapped beliefs/cb wholesale with CLAUDE.md regenerated, superseded cb:b401 by migration atom cb:b811 with the cb:b056 repoint, and opened PR #29. Graph 258 -> 392 nodes.
