...
description: Covers the rename of the dead term "assertions" to "beliefs" in cb:a098 and the mood fix it forces - the proposed prescription D that supersedes a098's first clause.
...
## The matter
cb:a098 (prescription/convention, pre-rename "directive") opens: *"Assertions express extractable behavioral
...
- Don't stop at the noun: "express" is mood-ambiguous (is/ought). A prescription's claim
...
## Next
Mint D as a prescription superseding a098. But the split of a098 into D (prescription) + an
